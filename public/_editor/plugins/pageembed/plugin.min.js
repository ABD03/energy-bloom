...
!(function () {
    ...
    c = (t) => (e) =>
      ((t) => {
        ...
        return null === t
          ...
          : "object" === e &&
            ((n = r = t),
            (i = String).prototype.isPrototypeOf(n) ||
    ...
    Y = (t, e) => {
      ...
      P(e, (t, e) => {
        ((t, e, n) => {
          ...
          ((t) => void 0 !== t.style && g(t.style.getPropertyValue))(t) &&
  ...
  var X = Object.create,
    ...
    at = it((t) => {
      ...
      (t.encode = function (t) {
        var n,
          ...
          s = (r = t) < 0 ? 1 + (-r << 1) : 0 + (r << 1);
        do {
          (n = 31 & s), (s >>>= 5) > 0 && (n |= 32), (i += e.encode(n));
        } while (s > 0);
        return i;
      }),
    ...
    lt = it((t) => {
      ...
      var s = (function (e) {
        ...
        return function (e) {
          for (var s = 0; s < n.length; s++)
            if (n[s].input === e) {
              var o = n[0];
              return (n[0] = n[s]), (n[s] = o), n[0].result;
            }
          var a = (function (e) {
            var n = e,
              s = r(e);
      ...
      function o(t, e) {
        ...
        var o = r(e),
          a = r(t);
        if ((a && (t = a.path || "/"), o && !o.scheme))
          return a && (o.scheme = a.scheme), i(o);
        if (o || e.match(n)) return e;
    ...
    ct = it((t) => {
      ...
      (i.fromArray = function (t, e) {
        for (var n = new i(), r = 0, s = t.length; r < s; r++) n.add(t[r], e);
        return n;
      }),
        ...
        (i.prototype.indexOf = function (t) {
          if (r) {
            ...
            if (n.call(this._set, s)) return this._set[s];
          }
      ...
      (s.prototype._version = 3),
        ...
        (s.prototype._serializeMappings = function () {
          for (
            ...
            if (((t = ""), (r = p[f]).generatedLine !== a))
              for (o = 0; r.generatedLine !== a; ) (t += ";"), a++;
            else if (f > 0) {
  ...
  function Bt(t, e) {
    ...
    if (
      ...
      dt(n) && ((e = jt(t, e + 1)), (n = t.charCodeAt(e))),
  ...
  function Ut(t) {
    if (1 === t.length && !pt(t.charCodeAt(0))) return t[0];
    let e = parseInt(t, 16);
    return (
  ...
  function $t(t) {
    ...
    (i[n] = o), (s[n] = a), (t.lines = i), (t.columns = s), (t.computed = !0);
  }
  var Gt = 16777215,
    Wt = 24,
    qt = new Map([
  ...
  function Jt(t, e) {
    ...
    function s(e) {
      for (e || (e = n(c++)), o = 5; c < t.length; c++) {
        let r = t.charCodeAt(c);
        switch (Et(r)) {
          case e:
            return void c++;
          case At:
            if (yt(r)) return (c += It(t, c, r)), void (o = 6);
            break;
          case 92:
  ...
  var Ht,
    ...
    Kt = new Set(["Atrule", "Selector", "Declaration"]),
    Yt = {};
  st(Yt, {
    safe: () => re,
    spec: () => ne,
  ...
  function ee(t) {
    let e = new Set(t.map(([t, e]) => (Xt(t) << 16) | Xt(e)));
    return function (t, n, r) {
      let i = Xt(n, r),
        s = r.charCodeAt(0);
      return (
        ((45 === s && 1 !== n && 2 !== n && 15 !== n) || 43 === s
          ? e.has((t << 16) | (s << 8))
          : e.has((t << 16) | i)) && this.emit(" ", 13, !0),
        i
      );
    };
  }
  ...
  st(oe, {
    ...
    Parentheses: () => nn,
    Percentage: () => sn,
    PseudoClassSelector: () => an,
    PseudoElementSelector: () => cn,
    Ratio: () => un,
    Raw: () => pn,
    Rule: () => fn,
    Selector: () => gn,
  ...
  function he(t, e) {
    ...
    for (
      (r === ae || r === le) &&
      (e && this.error("Number sign is not allowed"), n++);
      n < this.tokenEnd;
      n++
    )
  ...
  function fe() {
    ...
    if (10 !== n) {
      if (!this.isDelim(ae, t) && !this.isDelim(le, t)) return null;
      e = this.isDelim(ae, t) ? ae : le;
      do {
        n = this.lookupType(++t);
      } while (13 === n || 25 === n);
      10 !== n && (this.skip(t), de.call(this, ue));
    }
    return (
      t > 0 && this.skip(t),
      0 === e &&
        ((n = this.charCodeAt(this.tokenStart)),
        n !== ae && n !== le && this.error("Number sign is expected")),
      de.call(this, 0 !== e),
      e === le ? "-" + this.consume(10) : this.consume(10)
    );
  }
  function me() {
    let t = this.tokenStart,
      e = null,
      n = null;
    if (10 === this.tokenType) de.call(this, !1), (n = this.consume(10));
    else if (1 === this.tokenType && this.cmpChar(this.tokenStart, le))
      switch (
        ((e = "-1"), pe.call(this, 1, ce), this.tokenEnd - this.tokenStart)
      ) {
        case 2:
          this.next(), (n = fe.call(this));
          break;
        case 3:
          pe.call(this, 2, le),
            this.next(),
      ...
      1 === this.tokenType ||
      (this.isDelim(ae) && 1 === this.lookupType(1))
    ) {
      let r = 0;
      switch (
        ((e = "1"),
        this.isDelim(ae) && ((r = 1), this.next()),
        pe.call(this, 0, ce),
      ...
      s === this.tokenStart + i &&
        this.error("Integer is expected", this.tokenStart + i),
        pe.call(this, s - this.tokenStart, ce),
        (e = this.substring(t, s)),
        s + 1 === this.tokenEnd
          ? (this.next(), (n = fe.call(this)))
          : (pe.call(this, s - this.tokenStart + 1, le),
            s + 2 === this.tokenEnd
              ? (this.next(),
                this.skipSC(),
                de.call(this, ue),
                (n = "-" + this.consume(10)))
              : (he.call(this, s - this.tokenStart + 2, ue),
                this.next(),
                (n = this.substrToCursor(s + 1))));
    } else this.error();
    return (
      null !== e && e.charCodeAt(0) === ae && (e = e.substr(1)),
      null !== n && n.charCodeAt(0) === ae && (n = n.substr(1)),
      {
        type: "AnPlusB",
  ...
  function Ae() {
    ...
    return (
      this.isDelim(Se)
        ? ((e = !0), this.next())
        : this.isDelim(we) || this.eat(1),
      this.isDelim(we)
        ? this.charCodeAt(this.tokenStart + 1) !== ve
  ...
  function Le() {
    ...
    return (
      ...
      this.next(),
      e !== ve &&
        (this.isDelim(ve) || this.error("Equal sign is expected"), this.next()),
    ...
    return (
      ...
      20 !== this.tokenType &&
        (1 !== this.tokenType &&
          ...
          this.skipSC()),
        1 === this.tokenType && ((i = this.consume(1)), this.skipSC())),
      this.eat(20),
      {
  ...
  function Ze(t) {
    this.node(t.nth),
      null !== t.selector && (this.token(1, "of"), this.node(t.selector));
  }
  function tn(t) {
  ...
  function dn(t, e, n) {
    let r,
      i = this.getTokenStart(t);
    return (
      this.skipUntilBalanced(t, e || this.consumeUntilBalanceEnd),
      (r = n && this.tokenStart > i ? hn.call(this) : this.tokenStart),
      {
        type: "Raw",
  ...
  function kn() {
    ...
    for (; !this.eof && (t.push(this.Selector()), 18 === this.tokenType); )
      this.next();
    return {
      type: "SelectorList",
      loc: this.getLocationFromList(t),
  ...
  function Cn(t) {
    ...
    for (let n = r; n <= i; n++) {
      ...
      if (r === bn) {
        ...
        if (((r = t.charCodeAt(++n)), St(bn, r))) {
          let e = n - 1,
            r = Dt(t, e);
          (n = r - 1), (s += Ut(t.substring(e + 1, r)));
  ...
  function Tn() {
    ...
    return (
      this.isDelim(124)
        ? (this.next(), _n.call(this))
        : (_n.call(this), this.isDelim(124) && (this.next(), _n.call(this))),
      {
        type: "TypeSelector",
        loc: this.getLocation(t, this.tokenStart),
        name: this.substrToCursor(t),
  ...
  var Un = (function (t) {
      ...
      return function (t, n) {
        ...
        n &&
          ("function" == typeof n.decorator && (s = n.decorator(s)),
          n.sourceMap &&
            (s = (function (t) {
              let e = new Qt.SourceMapGenerator(),
                n = {
                  line: 1,
                  column: 0,
                },
                ...
                c = t.node;
              t.node = function (t) {
                if (t.loc && t.loc.start && Kt.has(t.type)) {
                  ...
                  (r.line !== c || r.column !== u) &&
                    ...
                    l &&
                      ((l = !1),
                      (n.line !== i.line || n.column !== i.column) &&
                        e.addMapping(s)),
                    (l = !0),
                    e.addMapping({
                      source: t.loc.source,
                ...
                c.call(this, t),
                  l && Kt.has(t.type) && ((i.line = o), (i.column = a));
              };
              let u = t.emit;
              t.emit = function (t, e, n) {
                for (let e = 0; e < t.length; e++)
                  10 === t.charCodeAt(e) ? (o++, (a = 0)) : a++;
                u(t, e, n);
              };
              let h = t.result;
              return (
          ...
          n.mode in Yt && (s.tokenBefore = Yt[n.mode]));
        let o = {
          node: (t) => s.node(t),
          children: ie,
    ...
    Vn = class {
      ...
      *[Symbol.iterator]() {
      ...
      reduce(t, e, n = this) {
        let r,
          i = this.allocateCursor(null, this.head),
          s = e;
        for (; null !== i.next; )
          (r = i.next), (i.next = r.next), (s = t.call(n, s, r.data, r, this));
        return this.releaseCursor(), s;
      }
      reduceRight(t, e, n = this) {
        let r,
          i = this.allocateCursor(this.tail, null),
          s = e;
        for (; null !== i.prev; )
          (r = i.prev), (i.prev = r.prev), (s = t.call(n, s, r.data, r, this));
        return this.releaseCursor(), s;
      }
      some(t, e = this) {
        for (let n = this.head; null !== n; n = n.next)
          if (t.call(e, n.data, n, this)) return !0;
        return !1;
      }
      map(t, e = this) {
        let n = new Vn();
      ...
      prependData(t) {
        return this.prepend(Vn.createItem(t));
      }
      append(t) {
        return this.insert(t);
      }
      appendData(t) {
        return this.insert(Vn.createItem(t));
      }
      insert(t, e = null) {
        if (null !== e)
      ...
      insertData(t, e) {
        return this.insert(Vn.createItem(t), e);
      }
      remove(t) {
        if ((this.updateCursors(t, t.prev, t, t.next), null !== t.prev))
          t.prev.next = t.next;
        else {
      ...
      push(t) {
        this.insert(Vn.createItem(t));
      }
      pop() {
        return null !== this.tail ? this.remove(this.tail) : null;
      }
      unshift(t) {
        this.prepend(Vn.createItem(t));
      }
      shift() {
          ...
          null === t.head ||
            (null != e
              ? (this.updateCursors(e.prev, t.tail, e, t.head),
                null !== e.prev
                  ? ((e.prev.next = t.head), (t.head.prev = e.prev))
                  : (this.head = t.head),
                (e.prev = t.tail),
                (t.tail.next = e))
    ...
    Gn = 60,
    Wn = "    ";
  function qn({ source: t, line: e, column: n }, r) {
    function i(t, e) {
      return s
        .slice(t, e)
    ...
    let s = t.split(/\r\n?|\n|\f/),
      ...
      c = 0;
    (n +=
      (Wn.length - 1) * (s[e - 1].substr(0, n - 1).match(/\t/g) || []).length) >
      $n && ((c = n - Gn + 3), (n = Gn - 2));
    for (let t = o; t <= a; t++)
      t >= 0 &&
        t < s.length &&
        ((s[t] = s[t].replace(/\t/g, Wn)),
        (s[t] =
          (c > 0 && s[t].length > c ? "\u2026" : "") +
          s[t].substr(c, $n - 2) +
          (s[t].length > c + $n - 1 ? "\u2026" : "")));
    return [i(o, e), new Array(n + l + 2).join("-") + "^", i(e, a)]
      .filter(Boolean)
      .join("\n");
  }
  ...
  function Hn(t) {
    ...
    for (; !this.eof; ) {
      ...
      if (void 0 === i) break;
      n && (t.onWhiteSpace && t.onWhiteSpace.call(this, i, e, r), (n = !1)),
        e.push(i);
    }
  ...
  st(rr, {
    ...
    Nth: () => Xe,
    Percentage: () => rn,
    PseudoClassSelector: () => on,
    PseudoElementSelector: () => ln,
    Raw: () => dn,
    Selector: () => mn,
    SelectorList: () => kn,
    String: () => wn,
  ...
  var ir = (function (t) {
      let e = "",
        ...
        a = Object.assign(
          new (class {
            ...
            lookupType(t) {
              return (t += this.tokenIndex) < this.tokenCount
                ? this.offsetAndType[t] >> Wt
                : 0;
            }
            lookupOffset(t) {
              return (t += this.tokenIndex) < this.tokenCount
            ...
            isDelim(t, e) {
              return e
                ? 9 === this.lookupType(e) &&
                    this.source.charCodeAt(this.lookupOffset(e)) === t
                : 9 === this.tokenType &&
            ...
            skip(t) {
              ...
              e < this.tokenCount
                ? ((this.tokenIndex = e),
                  (this.tokenStart = this.offsetAndType[e - 1] & Gt),
            ...
            skipUntilBalanced(t, e) {
              ...
              t: for (
                ;
                i < this.tokenCount && ((n = this.balance[i]), !(n < t));
                i++
              )
                switch (
                  ((r =
            ...
            forEachToken(t) {
              for (
                let e = 0, n = this.firstCharOffset;
                e < this.tokenCount;
                e++
              ) {
                let r = n,
            ...
            for (let n in t.parseContext)
              switch (typeof t.parseContext[n]) {
                case "function":
                  ...
                  break;
                case "string":
                  e.context[n] = Kn(t.parseContext[n]);
              }
            return {
              config: e,
              ...e,
          ...
          })(t || {}),
          {
            ...
            consumeUntilLeftCurlyBracketOrSemicolon: (t) =>
              123 === t || 59 === t ? 1 : 0,
            consumeUntilExclamationMarkOrSemicolon: (t) =>
              33 === t || 59 === t ? 1 : 0,
            consumeUntilSemicolonIncluded: (t) => (59 === t ? 2 : 0),
            createList: () => new Vn(),
            createSingleNodeList: (t) => new Vn().appendData(t),
            ...
            eat(t) {
              if (this.tokenType !== t) {
                ...
                switch (t) {
                  ...
                  case 4:
                    this.isDelim(35) &&
                      (this.next(), r++, (n = "Name is expected"));
                    break;
                  case 11:
                    10 === this.tokenType &&
            ...
            eatIdent(t) {
              (1 !== this.tokenType || !1 === this.lookupValue(0, t)) &&
                this.error(`Identifier "${t}" is expected`),
                this.next();
            },
            eatDelim(t) {
              this.isDelim(t) ||
                this.error(`Delim "${String.fromCharCode(t)}" is expected`),
                this.next();
            },
            ...
            getLocationFromList(t) {
              if (r) {
                ...
                return o.getLocationRange(
                  null !== e
                    ? e.loc.start.offset - o.startOffset
                    : this.tokenStart,
                  null !== r
                    ? r.loc.end.offset - o.startOffset
                    : this.tokenStart,
                  n
                );
              }
      ...
      return Object.assign(
        function (t, l) {
          (e = t),
            ...
            (i = "function" == typeof l.onParseError ? l.onParseError : Qn),
            (s = !1),
            (a.parseAtrulePrelude =
    ...
    sr = (t, e) =>
      t.a === e.a ? (t.b === e.b ? t.c - e.c : t.b - e.b) : t.a - e.a,
    or = (t, e) => 0 === sr(t, e),
    ar = (t, e) => sr(t, e) > 0,
    lr = (t, e) => sr(t, e) < 0,
    cr = (t, e = "ASC") => {
              ...
              switch (t.name.toLowerCase()) {
                ...
                case "nth-last-child":
                  if (((e.b += 1), t.children.first.selector)) {
                    let n = dr(...fr(t.children.first.selector));
                    (e.a += n.a), (e.b += n.b), (e.c += n.c);
                  }
                  break;
                case "host-context":
    ...
    fr = (t) => {
      ...
      let e = ((t) => {
        if ("string" == typeof t || t instanceof String)
          try {
            ...
            throw new TypeError(
              `Could not convert passed in source '${t}' to SelectorList: ${e.message}`
            );
          }
      ...
      if ("Selector" === e.type) return [pr(t)];
  ...
  const gr = (t) => {
    ...
    br = (t) => {
      const e = t.cssRules;
      return E(e, (t) =>
        ((t) => t.type === window.CSSRule.IMPORT_RULE)(t)
          ? br(t.styleSheet)
          : ((t) => t.type === window.CSSRule.STYLE_RULE)(t)
          ? [yr(t)]
          : []
      );
    },
    ...
    vr = (t, e, n) => {
      ...
      ((t, e, n) => {
        ...
        n && A(r, (t) => ("class", void t.dom.removeAttribute("class")));
      })(e, r, n);
    };
  const Cr = (t) => {
      return (
            ...
            ((t, e) =>
              L(t, (t) =>
                ((t, e) =>
                  ((t, e, n) =>
                    "" === e ||
                    (t.length >= e.length && t.substr(0, 0 + e.length) === e))(
                    t,
                    e
                  ))(t.selector, e)
              ))(t, n),
  ...
  const Ar = (t, e, n) =>
      wr((t) => ((t, e) => L(t, (t) => w(e, t.selector)))(t, n), t, e, !1),
    Lr = (t, e, n) => {
    ...
    _r = (t, e, n, r) => {
      ...
      var o, a;
      return (
        Lr(s, "src", t.source.value),
        Lr(s, "title", t.title),
        Lr(s, "name", t.name),
        Lr(s, "longdesc", t.descriptionUrl.value),
        ((o = t),
        (a = "dimensions"),
        ((t, e) => I.call(t, e))(o, a) ? b.from(o[a]) : b.none()).each((t) => {
          Lr(s, "width", t.width), Lr(s, "height", t.height);
        }),
        ...
        ((t) => {
          ...
          return K(e, n), ((t) => t.dom.innerHTML)(e);
        })(i)
      );
    },
    Tr = (t) => {
      const e = [
        ...
        n = (r) => ({
          ...
          onChange: (t, { name: e }) => {
            "size" === e && (t.redial(n(t.getData())), t.focus("size"));
          },
          onSubmit: (e) => {
            const n = e.getData();
        ...
        i =
          ...
          b
            ...
            .filter(G)
            .bind(Q)
            .filter((t) => N(t) && "iframe" === t.dom.nodeName.toLowerCase())
            .fold(
              () => l,
              (t) => {
                ...
                return {
                  ...
                  showBorder: D(t, "frameborder")
                    .map((t) => "0" !== t.toLowerCase())
                    .getOr(l.showBorder),
                  scrollbar: D(t, "scrolling")
                    .map((t) => "yes" === t.toLowerCase())
                    .getOr(l.scrollbar),
                };
              }
            ));
  ...
  tinymce.PluginManager.requireLangPack(
    ...
    tinymce.PluginManager.add("pageembed", (t, n) =>
      ((t, n) =>
        !!t &&
        -1 ===
          ((t, n) => {
        ...
        ? (console.error(
            "The pageembed plugin requires at least version 6.8.0 of TinyMCE"
          ),
          {})
        : (((t, e) => {
                ...
                .each((t) => {
                  G(t) &&
                    ((t, e) => {
                      ...
                      return (
                        !(!n || !n.hasAttribute) &&
                        n.hasAttribute("data-mce-selected")
                      );
                    })(t) &&
                    M(t, "data-mce-selected", "2");
                });
            }),
              t.on("PreInit", () => {
          ...
          ((t) => {
            t.ui.registry.addToggleButton("pageembed", {
              ...
              onSetup: (e) => {
                ...
                return t.on("nodechange", n), () => t.off("nodechange", n);
              },
            }),
              t.ui.registry.addMenuItem("pageembed", {
                ...
                onSetup: (e) => {
                  ...
                  return (
                    t.on("nodechange", n), n(), () => t.off("nodechange", n)
                  );
                },
              });
          })(t),
          ((t, e) => {
            ...
            t.on("PreInit", () => {
              ...
              if (tinymce.Resource.has(e)) {
                ...
                ((t) =>
                  t.inline ? t.ui.styleSheetLoader : t.dom.styleSheetLoader)(
                  t
                ).loadRawCss(e, n);
              } else t.contentCSS.push(t.documentBaseURI.toAbsolute(n));
            });
          })(t, n),
          {})
    );
